...
public interface Payv2PayOrderMapper extends BaseMapper<Payv2PayOrder> {
	...
	*/
	 ...
	 * Map<String,Object>    返回类型
	 */
	Map<String,Object> curxData(Map<String,Object> map);
	/**
	 * 
	 * refundData
	 * 数据汇总退款数据
	 ...
	 * Map<String,Object>    返回类型
	 */
	Map<String,Object> refundData(Map<String,Object> map);
	/**
	 * 
	 * groupByHour
	 * 以小时为单位查询实时统计数据
	...
	/**
	 * 获取今天商户的（成功/失败）交易金额总数
	 * 
	 * @param map
	 * @return
	 */
	Map<String,Object> getDayMoneySum2(Map<String,Object> map);
	
	Integer offlineOrderListCount(Map<String, Object> map);
	/**
	 * 商户线下APP获取订单列表
	 * 
	 * @param curPage 当前页
	 * @param pageData 每条条目数
	 * @param orderTime 订单时间
	 * @return
	 */	
	List<Payv2PayOrder> offlineOrderList(HashMap<String, Object> map);
	Double offlineOrderTotalMoney(Map<String,Object> map);
}