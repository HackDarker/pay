...
public interface Payv2PayOrderService extends BaseService<Payv2PayOrder,Payv2PayOrderMapper>  {
	...
	*/
	 ...
	 * @return
	 */
	PageObject<Payv2PayOrder> offlineOrderList(Map<String,Object> map);	
	 ...
	 * @return
	 */
	boolean callBackCom(Payv2PayOrder order, Payv2BussCompanyApp pbca,Payv2BussCompany pbc) throws Exception;
}
