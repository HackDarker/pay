...
pay_type             Integer(10)                 1          //支付方式，关联payv2_pay_type
...
account_type         Integer(10)                 1          //收款账号类型（1公司账户2个人账户）
account_name         String(50)                             //开户名称
account_card         String(50)                             //开户账号
pay_way_rate         Double(9,2)                 0.00       //通道费‰
bank_rate            Double(9,2)                 0.00       //银行结算费率
bank_rate_type       Integer(10)                 1          //清算方式（1.直清2.二清）
...
public class Payv2PayWayRate implements Serializable{
	...
	*/
	...
	public Integer getBankRateType() {
		return bankRateType;
	}

	public void setBankRateType(Integer bankRateType) {
