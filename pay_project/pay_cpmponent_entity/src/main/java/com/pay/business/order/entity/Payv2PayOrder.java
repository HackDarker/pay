...
group_id             Long(19)                               //订单分组id，关联payv2_pay_order_group表
...
out_transaction_id   String(50)                             //第三方订单号
pay_money            Double(9,2)                            //订单金额
pay_discount_money   Double(9,2)        NOTNULL  0.00       //折扣后的金额,也就是用户最终需要支付的金额
pay_way_money        Double(9,2)        NOTNULL  0.00       //通道费（以分为单位，小于分不收费）商户手续费
buss_way_rate        Double(9,2)                 0.00       //商户费率‰
cost_rate            Double(9,2)                 0.00       //成本费率‰
cost_rate_money      Double(9,2)                 0.00       //成本手续费
discount_id          Long(19)                               //优惠方案id，关联payv2_app_discount表
discount_money       Double(9,2)        NOTNULL  0.00       //优惠金额
...
user_agent           String(1000)                           //设备信息
method               String(50)                             //接口名
ip                   String(20)                             //用户ip
