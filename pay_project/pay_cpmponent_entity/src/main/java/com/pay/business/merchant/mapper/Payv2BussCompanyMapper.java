...
public interface Payv2BussCompanyMapper extends BaseMapper<Payv2BussCompany>{
	...
	public Map<String, Object> queryByCompanyKey(Map<String,Object> map);
	 ...
	 * @return
	 */
	public Payv2BussCompany queryCodeByKey(Map<String,Object> map);
	/**
	 * 查询商户token
	 * @param map
	 * @return
	 */
	public Payv2BussCompany queryTokenById(Map<String,Object> map);
}