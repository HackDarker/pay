...
company_key          String(64)                             //商户号,由系统生成
...
account_type         Integer(10)                 1          //收款账号类型,1:公司账户，2：个人账户
account_bank         String(50)                             //开户银行
account_name         String(50)                             //收款商户名（开户名称）
account_card         String(50)                             //收款账号（开户账号）
...
is_random            Integer(10)                 1          //支付通道是否随机1通道随机2通道按顺序3循环
...
public class Payv2BussCompany implements Serializable{
	...
	private Long dfRateId;		//代付通道id
	private Double payWayRate;	//商户代付费（每笔/元）
	private Double totalAmount;//商户资金池
	private String tradeName;//公司行业名称
	
	private String codeUrl;//商户收款码
	private Integer isRemark;//是否必填备注
	private String notifyUrl;//商户服务器回调地址
	private String token;//商户手机token
