...
public class WftWechatConfig {
     ...
     * 微信扫码接口类型
     */
    public static String PAY_SERVICE_WX = "pay.weixin.native";
    
    /**
     * QQ支付扫码接口类型
     */
    public static String PAY_SERVICE_QQ = "pay.tenpay.native";
    
    /**
     * 支付宝扫码接口类型
     */
    public static String PAY_SERVICE_ALI = "pay.alipay.native";
    
    /**
     * 支付宝扫码接口类型
     */
    public static String PAY_SERVICE_ALIJS = "pay.alipay.jspay";
