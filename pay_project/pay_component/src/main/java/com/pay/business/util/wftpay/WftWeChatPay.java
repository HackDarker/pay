...
public class WftWeChatPay {
    ...
    public static Map<String, String> pay(String body, String orderid, String money, String ip
    		,String appType,String mchId,String key,String dictName,String dictNameLike) {
    ...
    public static Map<String, String> appPay(String body, String orderid, String money, String ip
    		,String mchId,String key,String appId) {
        Map<String, String> returnMap = new ConcurrentHashMap<String, String>();
        try {
            // 构造下单所需要的参数
            SortedMap<String, String> map = new TreeMap<String, String>();
     ...
     * @return
     */
    public static Map<String, String> scanPay(String body, String orderid, String money, String ip
    		,String mchId,String key,String service) {
        Map<String, String> returnMap = new ConcurrentHashMap<String, String>();
        try {
            // 构造下单所需要的参数
            SortedMap<String, String> map = new TreeMap<String, String>();
     ...
     * @return
     */
    public static Map<String, String> alijsPay(String body, String orderid, String money, String ip
        ...
        try {
            ...
            //map.put("callback_url", "https://testpayapi.aijinfu.cn/page/pay/result.html");
            map.put("service", WftWechatConfig.PAY_SERVICE_ALIJS);
            //map.put("buyer_logon_id", "275079425@qq.com");
            ...
            if(resultMap.containsKey("sign")){
                if(!SignUtils.checkParam(resultMap, key)){
                    ...
                    if("0".equals(resultMap.get("result_code"))&&"0".equals(resultMap.get("status"))){
                    	String pay_info = resultMap.get("pay_info");
    ...
    public static void main(String[] args) throws Exception {
    	...
    	/*scanPay("测试支付", System.currentTimeMillis()+"", ""+DecimalUtil.yuanToCents("0.01"), "192.168.1.172"
    			, "101550068466", "37b559c8d3e45cb17e2d9dbc3cfcbc93","pay.weixin.native");
    	*/
    	alijsPay("测试支付", System.currentTimeMillis()+"", ""+DecimalUtil.yuanToCents("0.01"), "192.168.1.172"
    			, "101520142110", "18ae1d6c51e41512fc806baa56477e53");
    }
}
