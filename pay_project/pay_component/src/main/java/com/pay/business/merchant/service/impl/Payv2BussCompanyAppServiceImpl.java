...
public class Payv2BussCompanyAppServiceImpl extends BaseServiceImpl<Payv2BussCompanyApp, Payv2BussCompanyAppMapper> implements Payv2BussCompanyAppService {
	 ...
	 * @param companyId
	 */
	public void updateByComId(Long companyId){
		payv2BussCompanyAppMapper.updateByComId(companyId);
	}
	 ...
	 * @return
	 */
	public Payv2BussCompanyApp queryDetailById(Long id) {
		return payv2BussCompanyAppMapper.queryDetailById(id);
	}
}
