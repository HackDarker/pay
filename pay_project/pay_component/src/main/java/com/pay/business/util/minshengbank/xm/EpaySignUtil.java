...
public class EpaySignUtil{
     ...
     * @return
     */
    public static String sign(String prikeyvalue, Map<String, String> param) {
		...
		System.out.println("sign：" + sign_str);
        try {
    ...
    public static String signObj(String prikeyvalue, Map<String, Object> param) {
    	Set<String> set = param.keySet();
		List<String> keys = new ArrayList<String>(set);
		Collections.sort(keys);
		boolean start = true;
