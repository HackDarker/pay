...
public class Payv2BussCompanyShopServiceImpl extends BaseServiceImpl<Payv2BussCompanyShop, Payv2BussCompanyShopMapper> implements Payv2BussCompanyShopService {
	...
	public Payv2BussCompanyApp checkShop(String string) {
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("shopKey", string);
		Payv2BussCompanyShop shop = payv2BussCompanyShopMapper.queryByShopKey(map);
		Payv2BussCompanyApp app = new Payv2BussCompanyApp();
		app.setId(shop.getId());
		app.setCompanyId(shop.getCompanyId());
		app.setChannelId(shop.getChannelId());
		app.setIsRandom(shop.getIsRandom());
		app.setAppName(shop.getShopName());
		app.setCompanyName(shop.getCompanyName());
