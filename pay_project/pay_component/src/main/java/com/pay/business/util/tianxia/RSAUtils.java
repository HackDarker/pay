...
public class RSAUtils {
	...
	public static final String PRIVATE_KEY_PATH = "./dbli_pkcs8_rsa_private_key.pem";    //这里要换成自已的私钥key
	...
	public static final String MD5_KEY = "12345";    //测试环境MD5 key
	...
	public static boolean verify(byte[] data, String publicKey, String sign) throws Exception {
		byte[] digest = sha1(data);
		byte[] encryptData = decryptByPublicKey(Base64.decode(sign), publicKey);
