...
public class AliPayServiceImpl implements AliPayService {
	...
	public Map<String, String> aliPaycreatePayAndOreder(Payv2BussCompanyApp pbca, Integer payViewType, Map<String, Object> map) throws Exception {
		// 创建订单或者查询订单是否存在再给支付宝
		//3为扫码
		Map<String, String> orderMap = payv2PayOrderService.dyCreateOrder(map, pbca, payViewType, "SCAN");
		// 成功
		if (orderMap.get("status").equals(PayFinalUtil.PAY_STATUS_SUSSESS)) {
			...
			return PayRateDictValue.ratePay(orderMap.get("dictName").toString(), orderMap, ip, appType,"SCAN");
