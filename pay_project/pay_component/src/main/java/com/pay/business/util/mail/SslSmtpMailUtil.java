...
public class SslSmtpMailUtil {
    ...
    private String username = ReadProChange.getValue("suport_mail"); //smtp认证用户名和密码
//    private String username = "support@aijinfu.cn";
    private String password = ReadProChange.getValue("suport_mail_pass");
//    private String password = "JF123456jf123";
