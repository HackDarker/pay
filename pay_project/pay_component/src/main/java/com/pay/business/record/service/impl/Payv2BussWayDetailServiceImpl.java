...
public class Payv2BussWayDetailServiceImpl extends BaseServiceImpl<Payv2BussWayDetail, Payv2BussWayDetailMapper> implements Payv2BussWayDetailService {
	...
	public Map<Long, Payv2BussWayDetail> mouthBussWayDetaiList(Map<String, Object> map) {
		...
		for(Payv2BussWayDetail payv2BussWayDetail : bussDetailList){
			if(payv2BussWayDetail.getCompanyCheckId()!=null){
				if(map2.containsKey(payv2BussWayDetail.getPayWayId())){
					...
					allBussWayDetail.setBussMoney(DecimalUtil.add(allBussWayDetail.getBussMoney(),payv2BussWayDetail.getBussMoney()));//交易支付净额
					allBussWayDetail.setSuccessMoney(DecimalUtil.add(allBussWayDetail.getSuccessMoney(),payv2BussWayDetail.getSuccessMoney() ));//订单交易金额
					...
					if(payv2BussWayDetail.getRefundMoney()!=null){
						allBussWayDetail.setRefundMoney(DecimalUtil.add(allBussWayDetail.getRefundMoney(),payv2BussWayDetail.getRefundMoney() ));//退款金额
					}
					
					allBussWayDetail.setRateProfit(DecimalUtil.add(allBussWayDetail.getRateProfit(),(DecimalUtil.sub(payv2BussWayDetail.getBussWayRateMoney(),payv2BussWayDetail.getCostRateMoney()))));//手续费利润
					allBussWayDetail.setCostRateMoney(DecimalUtil.add(allBussWayDetail.getCostRateMoney(),payv2BussWayDetail.getCostRateMoney() ));//成本手续费
					allBussWayDetail.setBussWayRateMoney(DecimalUtil.add(allBussWayDetail.getBussWayRateMoney(),payv2BussWayDetail.getBussWayRateMoney() ));//商户手续费
					allBussWayDetail.setAccountsMonry(DecimalUtil.add(allBussWayDetail.getAccountsMonry(), (DecimalUtil.sub(payv2BussWayDetail.getBussMoney(),payv2BussWayDetail.getBussWayRateMoney()))));//结算金额
				}else{
					...
					allBussWayDetail.setRateProfit(DecimalUtil.sub(payv2BussWayDetail.getBussWayRateMoney(),payv2BussWayDetail.getCostRateMoney() ));//手续费利润
					...
					allBussWayDetail.setAccountsMonry(DecimalUtil.sub(payv2BussWayDetail.getBussMoney(),payv2BussWayDetail.getBussWayRateMoney() ));//结算金额
	...
	public Map<String, Object> dayBussWayDetaiList(Map<String, Object> map) {
		...
		for(Payv2BussWayDetail payv2BussWayDetail : bussDetailList){
			payv2BussWayDetail.setRateProfit(DecimalUtil.sub(payv2BussWayDetail.getBussWayRateMoney(),payv2BussWayDetail.getCostRateMoney()));//手续费利润
			payv2BussWayDetail.setAccountsMonry(DecimalUtil.sub(payv2BussWayDetail.getBussMoney(),payv2BussWayDetail.getBussWayRateMoney() ));//结算金额
		}
