...
//	if($(".iosIphoneUrl input").val()){
//		if($(".iosIphoneUrl input").val().match(regUrl)) {
//			
//		} else {
//			$(".iosIphoneUrl input").attr("dataType","*")
//			$(".iosIphoneUrl input").attr("nullMsg","网址请加上http://或者https://前缀")
//			param.iosIphoneUrl = "";
...
//	if($(".iosIpaUrl input").val()){
//		
//		if($(".iosIpaUrl input").val().match(regUrl)) {
//			param.iosIpaUrl = $(".iosIpaUrl input").val();
//		} else {
//			$(".iosIpaUrl input").attr("dataType","*")
//			$(".iosIpaUrl input").attr("nullMsg","网址请加上http://或者https://前缀")
//			param.iosIpaUrl = "";
//			$(".iosIpaUrl input").val("");
//		};
//	}else{
...
//	if($(".androidAppUrl input").val()){
//		
//		if($(".androidAppUrl input").val().match(regUrl)) {
//			param.androidAppUrl = $(".androidAppUrl input").val();
//		} else {
//			//$(".androidAppUrl input").attr("dataType","*")
//			//$(".androidAppUrl input").attr("nullMsg","网址请加上http://或者https://前缀")
//			param.androidAppUrl = "";
